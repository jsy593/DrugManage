				...
				<form action="HomeServlet.do" method="post">
					...
					<table width="100%" align="center" border="0" cellspacing="0"
						...
						<tr>
							...
							<td><input type="text" class="form-control-static"
								height="34px" name="dname" value="${dq.dname  }" /></td>
							<td align="right">价格：</td>
							<td><input type="text" class="form-control-static"
								name="price1" />-- <input type="text"
								class="form-control-static" name="price2" />元</td>

							<td>类型：</td>
							<td><select name="type" class="style_serach">
									<option value=""></option>
									<option value="OTC">OTC</option>
									<option value="处方药">处方药</option>
							</select></td>

							<td width="2%"><input type="submit" class="btn btn-info"
								value="查询" /></td>
						</tr>
					</table>
				</form>
				...
				<table class="table table-border table-condensed table-hover ">
					...
					<c:forEach var="drug" items="${requestScope.druginfo}">
						<tr>
							...
							<td>${drug.indate}</td>
							<td>${drug.anumber}</td>
							<td><a href="AddServlet.do?method=update&did=${drug.did}"
								style="color: orange"><b>修改</b></a> <a
								href="AddServlet.do?method=delete&did=${drug.did}"
								style="color: gary"><b>删除</b></a></td>
						</tr>
					</c:forEach>
				</table>

		...
		<div class="blank">
			...
			<div class="blank-page">
				<div class="grid-form1">
					<form class="form-horizontal" action="AddServlet.do?method=add"
						name="form1" method="post" onsubmit="return add()">
						<table width="400" height="400" border="0" cellpadding="0"
							cellspacing="0">
							<tr>
								<td width="30%" align="center">药品名称：</td>
								<td width="70%"><input type="text"
									class="form-control-static" name="dname" /><span id="dname">必填</span></td>
							</tr>
							<tr>
								<td width="20%" align="center">规格：</td>
								<td width="80%"><input type="text"
									class="form-control-static" name="guige" /></td>
							</tr>
							<tr>
								<td width="20%" align="center">价格:</td>
								<td width="80%"><input type="text"
									class="form-control-static" name="price" /></td>
							</tr>
							<tr>
								<td width="20%" align="center">功效:</td>
								<td width="80%"><input type="text"
									class="form-control-static" name="effect" /></td>
							</tr>
							<tr>
								<td width="20%" align="center">药品类型:</td>
								<td width="80%"><input type="text"
									class="form-control-static" name="type" /></td>
							</tr>
							<tr>
								<td width="20%" align="center">生产厂家:</td>
								<td width="80%"><input type="text"
									class="form-control-static" name="factory" /><span
									id="factory">必填</span></td>
							</tr>
							<tr>
								<td width="20%" align="center">生产日期:</td>
								<td width="80%"><input type="text" onclick="laydate()"
									class="form-control-static" name="date" /><span id="date">必填</span></td>
							</tr>
							<tr>
								<td width="20%" align="center">有效期:</td>
								<td width="80%"><input type="text"
									class="form-control-static" name="indate" /><span id="indate">必填</span></td>
							</tr>
							<tr>
								<td width="20%" align="center">批准文号:</td>
								<td width="80%"><input type="text"
									class="form-control-static" name="anumber" /><span
									id="anumber">必填</span></td>
							</tr>
							<tr>
								<td width="20%"></td>
								<td width="80%">
									<div class="col-md-6 login-do" style="margin: 10px 0px">
										<label class="hvr-shutter-in-horizontal login-sub"> <input
											type="submit" class="hvr-shutter-in-horizontal" value="提交" />
